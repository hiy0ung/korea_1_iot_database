...
from 
	`korea_db`.`members`;
-- 표기법은 보기 편하게 알아서 실무자마다 다름 (위, 아래 같은 코드)
...
# >> 별칭에 공백이 있을 경우 문자열을 나타내는 따옴표로 묶어야한다
...
select * from members
where
	points between 200 and 400; -- 200 이상, 400 이하
# : 주로 숫자형 데이터에 사용
